    ...
    return (
        <div className="container my-5 pt-5 text-center">
            <div className=''> 
                ...
                <div>
                    <img src={service.image} alt={service.title} className="img-fluid rounded-4 my-3" style={{ maxWidth: "100%", height: "auto" }} />
                </div>
            </div>
            <p>{service.article}</p>
            <HashLink to="/#contact" className="btn btn-dark mt-3">اطلب الخدمة</HashLink>
        </div>
    );
}
