...
function Team() {
  ...
  return (
    ...
    >
      {/* Helmet SEO */}
      <Helmet>
        <title>الطاقم الطبي | مركز سليم سمايل – رام الله</title>
        <meta
          name="description"
          content="تعرف على الطاقم الطبي في مركز سليم سمايل – نخبة من الأطباء المتخصصين في زراعة الأسنان، تجميل الأسنان، وعلاج الأسنان العام."
        />
        <meta
          name="keywords"
          content="أطباء الأسنان, الطاقم الطبي, مركز سليم سمايل, رام الله, زراعة الأسنان, تجميل الأسنان"
        />
        {/* OG Tags */}
        <meta property="og:title" content="الطاقم الطبي | مركز سليم سمايل" />
        <meta
          property="og:description"
          content="فريق من نخبة الأطباء المتخصصين في مركز سليم سمايل يقدمون أفضل خدمات طب الأسنان."
        />
        <meta
          property="og:image"
          content="https://slimsmile.ps/images/team-cover.jpg"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            department: teamMembers.map((doc) => ({
              "@type": "Physician",
              name: doc.name,
              description: doc.role,
              image: `https://slimsmile.ps${doc.image}`,
              medicalSpecialty: doc.role,
            })),
          })}
        </script>
      </Helmet>
